...
ExportDialog.exportFile = function (editorUi, name, format, bg, s, b) {
    ...
    if (format === 'xml') {
        ...
        if(item_likelihood !== null){
            ...
            for (let [key, value] of dico_likelihood) {
            ...
            if (format === 'pdf') {
                ...
                let docDefinition = {
                    content: [{
                        ...
                        'We therefore propose the analysis of the main threats to be studied.', {
                            text: '\n I - Bowtie diagram',
                            style: 'subheader',
                            color: '#00008B'
                        }, {
                        ...
                        'This section presents an analysis of the main risks.\n\n We remind the parameters of the likelihood matrix :',
                        '\n', {
                            style: 'tableExample',
                            table: {
                                widths: [100, 50, '*'],
                                body: [
                                    ...
                                    ['Cause name 1', 'Total likelihood 1', 'Actual description 1'],
                                    ['Cause name 2', 'Total likelihood 2', 'Actual description 2'],
                                    ['Cause name 3', 'Total likelihood 3', 'Actual description 3']
                                ]
                            }
                        }, {
                        ...
                        'We remind the parameters of the likelihood matrix :', {
                            bold: true,
                            ul: [
                                'ACT = Actors : the level of skills needed to perform the attack',
                                'OPP = Opportunity : the presence of a favorable combination of circumstances that makes an action possible',
                                'MEA = Means : resources needed to perform the attack',
                                'MTV = Motivation : reasons that lead the attacker to perform the attack'
                            ]
                        },
                        '\n', {
                            style: 'tableExample',
                            table: {
                                ...
                                body: [
                                    ...
                                    ['Cause name 1', 'grade', 'grade', 'grade', 'grade', 'grade'],
                                    ['Cause name 2', 'grade', 'grade', 'grade', 'grade', 'grade'],
                                    ['Cause name 3', 'grade', 'grade', 'grade', 'grade', 'grade']
                                ]
                            }
                        },
                        ...
                        '\n', {
                            ...
                            table: {
                                ...
                                body: [
                                    ...
                                    ['Cause name 1', 'Total impact 1', 'Actual description 1'],
                                    ['Cause name 2', 'Total impact 2', 'Actual description 2'],
                                    ['Cause name 3', 'Total impact 3', 'Actual description 3']
                                ]
                            }
                        }, {
                        ...
                        '\n', {
                            ...
                            table: {
                                widths: [200, 50, 50, 50, 50, 60],
                                body: [
                                    ['Impact', 'COM', 'REP', 'ENV', 'IND', 'Total impact'],
                                    ['Impact name 1', 'grade', 'grade', 'grade', 'grade', 'grade'],
                                    ['Impact name 2', 'grade', 'grade', 'grade', 'grade', 'grade'],
                                    ['Impact name 3', 'grade', 'grade', 'grade', 'grade', 'grade']
                                ]
                            }
                        }
